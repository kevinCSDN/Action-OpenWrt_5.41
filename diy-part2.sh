...
git clone https://github.com/kevinCSDN/sirpdboy-package/luci-theme-btmob package/luci-theme-btmob
git clone https://github.com/kevinCSDN/sirpdboy-package/luci-theme-upnp package/luci-theme-upnp
